 ...
 * navigation buttons as options. The direction is used to define the scroller direction, check above.
 *
 ...
 * @modifier Joe Chahoud/joechahhoud@gmail.com
 */
...
(function ($) {                                          // Compliant with jquery.noConflict()
    $.fn.jCarouselLite = function (o) {
        o = $.extend({
            ...
            vertical: false,
            circular: true,
            direction: 1, // (1 scroll to right || 0 scroll to left in case of horizontal) OR (1 scroll to bottom || 0 scroll to top in case of vertical)
            visible: 3,
            start: 0,
            scroll: 1,
        ...
        return this.each(function () {                           // Returns the element collection. Chainable.
            ...
            var running = false, direction = o.direction, animCss = o.vertical ? (direction == 1 ? "top" : "bottom") : (direction == 1 ? "right" : "left"), sizeCss = o.vertical ? "height" : "width";
            ...
            li.css({ overflow: "hidden", float: o.vertical ? "none" : (direction == 1 ? "right" : "left") });
            ul.css({ margin: "0", padding: "0", position: "relative", "list-style-type": "none", "z-index": "1" });
            if (direction == 1) {
                div.css({ overflow: "hidden", position: "relative", "z-index": "2", right: "16px" });
            } else {
                div.css({ overflow: "hidden", position: "relative", "z-index": "2", left: "16px" });
            }
            ...
            if (o.btnPrev)
                $(o.btnPrev).click(function () {
                    return direction == 1 ? go(curr - o.scroll) : go(curr + o.scroll);
                });
            ...
            function go(to) {
                if (!running) {
                    ...
                    ul.animate(
                    animCss == "right" ? { right: -(curr * liSize)} : "left" ? { left: -(curr * liSize)} : "bottom" ? { bottom: -(curr * liSize)} : { top: -(curr * liSize) }, o.speed, o.easing,
                    function () {
                        if (o.afterEnd)
